                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                ...
                                                <?php
                                                $arg = array('type' => $dbs_sulata_faqs['faq__Question_html5_type'], 'name' => 'faq__Question', 'id' => 'faq__Question', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_faqs['faq__Question_max'], $dbs_sulata_faqs['faq__Question_html5_req'] => $dbs_sulata_faqs['faq__Question_html5_req'], 'class' => 'form-control');
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                                <label><?php echo $dbs_sulata_faqs['faq__Sequence_req']; ?><?php echo $dbs_sulata_faqs['faq__Sequence_title']; ?>:</label>
                                                <?php
                                                $arg = array('type' => $dbs_sulata_faqs['faq__Sequence_html5_type'], 'name' => 'faq__Sequence', 'id' => 'faq__Sequence', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_faqs['faq__Sequence_max'], $dbs_sulata_faqs['faq__Sequence_html5_req'] => $dbs_sulata_faqs['faq__Sequence_html5_req'], 'class' => 'form-control');
                                                echo suInput('input', $arg);
                                                ?>
                                            </div>
