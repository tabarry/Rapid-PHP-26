...
checkLogin();
$sql = "SELECT faq__ID,faq__Question,faq__Sequence,faq__Status FROM sulata_faqs WHERE  faq__dbState='Live'";
//Download CSV
if (suSegment(1) == 'stream-csv' && $downloadAccessCSV == TRUE) {
    $outputFileName = 'faqs.csv';
    $headerArray = array('Question', 'Sequence', 'Status');
...
if (suSegment(1) == 'stream-pdf' && $downloadAccessPDF == TRUE) {
    ...
    $fieldsArray = array('faq__Question', 'faq__Sequence', 'faq__Status');
    $headerArray = array('Question', 'Sequence', 'Status');
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                    ...
                                    <fieldset id="search-area1">
                                        ...
                                        <div class="col-xs-5 col-sm-2 col-md-2 col-lg-2">
                                            ...
                                            <?php if (isset($_GET['q'])) { ?>
                                                ...
                                                <div class="pull-right"><a class="underline" href="<?php echo ADMIN_URL; ?>faqs/">Clear search.</a></div>
                                            <?php } ?>
                                        </div>
                                    </fieldset>
                                </form>
                                ...
                                <?php if ($addAccess == 'true') { ?>
                                    <div id="table-area"><a href="<?php echo ADMIN_URL; ?>faqs-add<?php echo PHP_EXTENSION; ?>/" class="btn btn-black">Add new..</a></div>
                                <?php } ?>
                                ...
                                <table width="100%" class="table table-hover table-bordered tbl">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:45%">
                                                <?php echo $dbs_sulata_faqs['faq__Question_title']; ?>
                                            </th>
                                            <th style="width:20%">
                                                <?php echo $dbs_sulata_faqs['faq__Sequence_title']; ?>
                                            </th>
                                            <th style="width:20%">
                                                Status
                                            </th>
                                            <?php if (($editAccess == TRUE) || ($deleteAccess == TRUE) || ($restoreAccess == TRUE)) { ?>
                                                <th style="width:10%">
                                                    &nbsp;
                                                </th>
                                            <?php } ?>
                                    ...
                                    <tbody>
                                        <?php
                                        if ($_GET['q'] != '') {
                                            $where .= " AND faq__Question LIKE '%" . suStrip($_GET['q']) . "%' ";
                                        }
                                        ...
                                        foreach ($result['result'] as $row) {
                                            ...
                                            <tr id="card_<?php echo $row['faq__ID']; ?>">
                                                ...
                                                <td>
                                                    <?php echo $row['faq__Sequence']; ?>
                                                </td>
                                                <td>
                                                    <?php echo $row['faq__Status']; ?>
                                                </td>
                                ...
                                <?php
                                $sqlP = "SELECT COUNT(faq__ID) AS totalRecs FROM sulata_faqs WHERE faq__dbState='Live' $where";
                                suPaginate($sqlP);
                                ?>
                                <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>faqs<?php echo PHP_EXTENSION; ?>/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-download"></i> <?php echo DOWNLOAD_CSV;?></a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>faqs<?php echo PHP_EXTENSION; ?>/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-file-pdf-o"></i> <?php echo DOWNLOAD_PDF;?></a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <!--SU ENDS-->
