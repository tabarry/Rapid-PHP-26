                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <table width="100%" class="table table-hover table-bordered tbl">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:85%">
                                                <?php echo $dbs_sulata_headers['header__Title_req']; ?>
                                            </th>
                                ...
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>headers<?php echo PHP_EXTENSION; ?>/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-file-pdf-o"></i> <?php echo DOWNLOAD_PDF;?></a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <!--SU ENDS-->
