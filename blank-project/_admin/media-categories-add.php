                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <!--SU STARTS-->
                                <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>media-categories-remote<?php echo PHP_EXTENSION; ?>/add/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" enctype="multipart/form-data">			
