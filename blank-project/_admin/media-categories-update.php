...
if (suSegment(2) == 'duplicate') {
    $do = 'add';
    $pageName = 'Duplicate Media Category';
    $pageTitle = 'Duplicate Media Category';
} else {
    $do = 'update';
    $pageName = 'Update Media Category';
    $pageTitle = 'Update Media Category';
}
                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <!--SU STARTS-->
                                <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>media-categories-remote<?php echo PHP_EXTENSION; ?>/<?php echo $do; ?>/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" enctype="multipart/form-data">			
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label><?php echo $dbs_sulata_media_categories['mediacat__Name_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Name_title']; ?>:</label>
                                                <?php
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label><?php echo $dbs_sulata_media_categories['mediacat__Picture_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Picture_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                                            
                                                <label><?php echo $dbs_sulata_media_categories['mediacat__Description_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Description_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">                                            
                                                ...
                                                <label><?php echo $dbs_sulata_media_categories['mediacat__Type_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Type_title']; ?>:</label>
                                            ...
                                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">                                            
                                                <label><?php echo $dbs_sulata_media_categories['mediacat__Sequence_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Sequence_title']; ?>:</label>
                                                <?php
                                        ...
                                        <span id="divDimensions" style="display:none">
                                            <div class="form-group">
                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                    <label><?php echo $dbs_sulata_media_categories['mediacat__Thumbnail_Width_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Thumbnail_Width_title']; ?>:</label>
                                                    <?php
                                                ...
                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                    <label><?php echo $dbs_sulata_media_categories['mediacat__Thumbnail_Height_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Thumbnail_Height_title']; ?>:</label>
                                                    <?php
                                                ...
                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                    <label><?php echo $dbs_sulata_media_categories['mediacat__Image_Width_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Image_Width_title']; ?>:</label>
                                                    <?php
                                                ...
                                                <div class="col-xs-12 col-sm-3 col-md-3 col-lg-3">
                                                    <label><?php echo $dbs_sulata_media_categories['mediacat__Image_Height_req']; ?><?php echo $dbs_sulata_media_categories['mediacat__Image_Height_title']; ?>:</label>
                                                    <?php
