                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label><?php echo $dbs_sulata_media_files['mediafile__Category_req']; ?><?php echo $dbs_sulata_media_files['mediafile__Category_title']; ?>:
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label><?php echo $dbs_sulata_media_files['mediafile__Title_req']; ?><?php echo $dbs_sulata_media_files['mediafile__Title_title']; ?>:</label>
                                                <?php
                                                $arg = array('type' => $dbs_sulata_media_files['mediafile__Title_html5_type'], 'name' => 'mediafile__Title', 'id' => 'mediafile__Title', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_media_files['mediafile__Title_max'], $dbs_sulata_media_files['mediafile__Title_html5_req'] => $dbs_sulata_media_files['mediafile__Title_html5_req'], 'class' => 'form-control', 'value' => suUnstrip($row['mediafile__Title']));
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <label><?php echo $dbs_sulata_media_files['mediafile__File_req']; ?><?php echo $dbs_sulata_media_files['mediafile__File_title']; ?>:</label>
                                                <?php
                                                $arg = array('type' => $dbs_sulata_media_files['mediafile__File_html5_type'], 'name' => 'mediafile__File', 'id' => 'mediafile__File');
                                                echo suInput('input', $arg);
                                                ?>
                                                <?php if (file_exists(ADMIN_UPLOAD_PATH . $row['mediafile__File'])) { ?>
                                                    <a href="<?php echo BASE_URL . 'files/' . $row['mediafile__File']; ?>" target="_blank"><?php echo VIEW_FILE; ?></a>
                                                <?php } ?>   
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                                <label><?php echo $dbs_sulata_media_files['mediafile__Short_Description_req']; ?><?php echo $dbs_sulata_media_files['mediafile__Short_Description_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="small-12 medium-12 large-12 columns">
                                            <label><?php echo $dbs_sulata_media_files['mediafile__Long_Description_req']; ?><?php echo $dbs_sulata_media_files['mediafile__Long_Description_title']; ?>:</label>
                                            <?php
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
                                                ...
                                                <label>
                                                    <?php echo $dbs_sulata_media_files['mediafile__Date_req']; ?><?php echo $dbs_sulata_media_files['mediafile__Date_title']; ?>:</label>
                                                <?php
