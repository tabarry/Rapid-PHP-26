                                    ...
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label>
                                                    <?php echo $dbs_sulata_pages['page__Name_req']; ?><?php echo $dbs_sulata_pages['page__Name_title']; ?>:</label>
                                                <?php
                                                $js = "return $('#page__Permalink').val(doSlugify(this.value,'-'));";
                                                $arg = array('type' => $dbs_sulata_pages['page__Name_html5_type'], 'name' => 'page__Name', 'id' => 'page__Name', 'autocomplete' => 'off', 'maxlength' => $dbs_sulata_pages['page__Name_max'], $dbs_sulata_pages['page__Name_html5_req'] => $dbs_sulata_pages['page__Name_html5_req'], 'class' => 'form-control', 'value' => suUnstrip($row['page__Name']), 'onkeyup' => $js);
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <label><?php echo $dbs_sulata_pages['page__Heading_req']; ?><?php echo $dbs_sulata_pages['page__Heading_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                                                <label><?php echo $dbs_sulata_pages['page__Link_Position_req']; ?><?php echo $dbs_sulata_pages['page__Link_Position_title']; ?>:</label>
                                                <?php
                                            ...
                                            <div class="col-xs-12 col-sm-5 col-md-5 col-lg-5">
                                                <label><?php echo $dbs_sulata_pages['page__Parent_req']; ?><?php echo $dbs_sulata_pages['page__Parent_title']; ?>:
                                                    <?php if ($addAccess == 'true') { ?>    
                                            ...
                                            <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
                                                <label><?php echo $dbs_sulata_pages['page__Sequence_req']; ?><?php echo $dbs_sulata_pages['page__Sequence_title']; ?>:</label>
                                                <?php
