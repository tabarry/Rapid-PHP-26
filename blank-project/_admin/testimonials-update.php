...
if (suSegment(2) == 'duplicate') {
    $do = 'add';
    $pageName = 'Duplicate Testimonial';
    $pageTitle = 'Duplicate Testimonial';
} else {
    $do = 'update';
    $pageName = 'Update Testimonial';
                    ...
                    <div class="container">
                        ...
                        <div class="page-content">
                            ...
                            <div id="content-area">
                                ...
                                <form class="form-horizontal" action="<?php echo ADMIN_SUBMIT_URL; ?>testimonials-remote<?php echo PHP_EXTENSION; ?>/<?php echo $do; ?>/" accept-charset="utf-8" name="suForm" id="suForm" method="post" target="remote" >
                                    <div class="gallery clearfix">
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                
                                                <label><?php echo $dbs_sulata_testimonials['testimonial__Name_req']; ?><?php echo $dbs_sulata_testimonials['testimonial__Name_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                
                                                <label><?php echo $dbs_sulata_testimonials['testimonial__Location_req']; ?><?php echo $dbs_sulata_testimonials['testimonial__Location_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                
                                                <label><?php echo $dbs_sulata_testimonials['testimonial__Testimonial_req']; ?><?php echo $dbs_sulata_testimonials['testimonial__Testimonial_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">    
                                                <label><?php echo $dbs_sulata_testimonials['testimonial__Date_req']; ?><?php echo $dbs_sulata_testimonials['testimonial__Date_title']; ?>:</label>
                                                <?php
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">        
                                                <label><?php echo $dbs_sulata_testimonials['testimonial__Status_req']; ?><?php echo $dbs_sulata_testimonials['testimonial__Status_title']; ?>:</label>
                                                <?php
