                                ...
                                <table width="100%" class="table table-hover table-bordered tbl">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:21%"><?php echo $dbs_sulata_testimonials['testimonial__Name_title']; ?></th>
                                            <th style="width:21%"><?php echo $dbs_sulata_testimonials['testimonial__Location_title']; ?></th>
                                            <th style="width:21%"><?php echo $dbs_sulata_testimonials['testimonial__Date_title']; ?></th>
                                            <th style="width:21%"><?php echo $dbs_sulata_testimonials['testimonial__Status_title']; ?></th>
...
//Get records from database
                                        ...
                                        foreach ($result['result'] as $row) {
                                            ?>
                                            <tr id="card_<?php echo $row['testimonial__ID']; ?>">
                                                <td>
                                                    <?php echo $sr = $sr + 1; ?>.
                                                </td>
                                ...
                                <?php if ($downloadAccessCSV == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>testimonials<?php echo PHP_EXTENSION; ?>/stream-csv/" class="btn btn-black pull-right"><i class="fa fa-download"></i> <?php echo DOWNLOAD_CSV;?></a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
                                <?php if ($downloadAccessPDF == TRUE && $numRows > 0) { ?>
                                    <p>&nbsp;</p>
                                    <p><a target="remote" href="<?php echo ADMIN_URL; ?>testimonials<?php echo PHP_EXTENSION; ?>/stream-pdf/" class="btn btn-black pull-right"><i class="fa fa-download"></i> <?php echo DOWNLOAD_PDF;?></a></p>
                                    <p>&nbsp;</p>
                                    <div class="clearfix"></div>
                                <?php } ?>
