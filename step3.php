                        ...
                        <fieldset name="frmSet_<?php echo $i; ?>">
                            ...
                            <form style="display:none" name="suForm_<?php echo $i; ?>" action="step4.php" method="post" id="suForm_<?php echo $i; ?>" target="remote_<?php echo $i; ?>" onsubmit="return validate3('suForm_<?php echo $i; ?>');">
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpading="0">
                                    <tr>
                                        <td class="rowHeader" width="4%">&nbsp;Sr.</td>
                                        <td class="rowHeader" width="24%">Field</td>
                                        <td class="rowHeader" width="24%">Show, Order by, Search By, Display as, Resize</td>
                                        <td class="rowHeader" width="24%">Default Value</td>
                                        <td class="rowHeader" width="24%">Field Type</td>
                                    </tr>
                                    <?php
                                    $sql = "USE " . $_POST["db"];
